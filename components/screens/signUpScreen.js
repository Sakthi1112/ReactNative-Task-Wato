...
export default function SignUpScreen() {
  ...
  const CustomCheckbox = () => (
    <TouchableOpacity
      style={[styles.checkbox, isChecked ? styles.checkboxChecked : null]}
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Please sign-up for your account</Text>
      <LinearGradient
      ...
      >
        ...
        <View style={styles.checkboxContainer}>
          ...
          <TouchableOpacity>
            <Text style={styles.policy}>
              <Text style={{ color: 'white' }}>I agree</Text> to privacy policy & terms
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <TouchableOpacity>
          <Text style={styles.createAccount} onPress={handleLogin}>
            <Text style={styles.whiteText}>Already have an account? </Text>Sign in instead
          </Text>
        </TouchableOpacity>
